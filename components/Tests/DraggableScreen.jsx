  ...
  return (
    ...
    >
      <div
        ...
        className="relative p-4 border border-gray-300 bg-white bg-opacity-90 rounded-lg shadow-md flex flex-col items-center w-full sm:w-3/4 md:w-1/2 lg:w-1/3 xl:w-1/4 pointer-events-auto"
      >
